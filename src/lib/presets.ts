...
export const PRESETS: MatrixPreset[] = [
  ...
  },
  {
    ...
    config: {
      ...
      xAxisLabel: 'Economic Left ↔ Economic Right',
      yAxisLabel: 'Libertarian ↕ Authoritarian',
      xMin: 0, xMax: 10, yMin: 0, yMax: 10,
      showDiagonal: false,
      diagonalPoints: { x1: 0, y1: 0, x2: 10, y2: 10 },
    },
    zones: [
      { id: 'authleft', name: 'Authoritarian Left', color: 'hsla(0, 75%, 55%, 0.5)', x1: 0, y1: 5, x2: 5, y2: 10 },
      { id: 'authright', name: 'Authoritarian Right', color: 'hsla(220, 75%, 55%, 0.5)', x1: 5, y1: 5, x2: 10, y2: 10 },
      { id: 'libleft', name: 'Libertarian Left', color: 'hsla(120, 55%, 45%, 0.5)', x1: 0, y1: 0, x2: 5, y2: 5 },
      { id: 'libright', name: 'Libertarian Right', color: 'hsla(52, 95%, 58%, 0.5)', x1: 5, y1: 0, x2: 10, y2: 5 },
    ],
    points: [],
  },
  {
...
export const COLOR_SCHEMES: Record<string, Record<string, string>> = {
  ...
  grayscale: {
    nogo: 'hsla(0, 0%, 85%, 0.5)',
    fun: 'hsla(0, 0%, 70%, 0.5)',
    danger: 'hsla(0, 0%, 55%, 0.5)',
    date: 'hsla(0, 0%, 90%, 0.5)',
    wife: 'hsla(0, 0%, 95%, 0.5)',
    unicorn: 'hsla(0, 0%, 80%, 0.5)',
  },
};
